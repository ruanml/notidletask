...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Wed Jan 4 23:15:51 2012
# Project:  notidletask.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile notidletask.pro
#############################################################################
...
Makefile: notidletask.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -unix CONFIG+=debug -o Makefile notidletask.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/notidletask1.0.0/ && $(COPY_FILE) --parents mainwindow.h isystemidle.h linuxsystemidle.h configuration.h main.h .tmp/notidletask1.0.0/ && $(COPY_FILE) --parents images.qrc .tmp/notidletask1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp linuxsystemidle.cpp isystemidle.cpp configuration.cpp .tmp/notidletask1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/notidletask1.0.0/ && (cd `dirname .tmp/notidletask1.0.0` && $(TAR) notidletask1.0.0.tar notidletask1.0.0 && $(COMPRESS) notidletask1.0.0.tar) && $(MOVE) `dirname .tmp/notidletask1.0.0`/notidletask1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/notidletask1.0.0
...
moc_isystemidle.cpp: configuration.h \
		isystemidle.h
